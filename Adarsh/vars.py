...
class Var(object):
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', "mongodb+srv://tentukottamovie:148644@tentukottamovie.s1pkcuk.mongodb.net/?retryWrites=true&w=majority&appName=tentukottamovie"))
